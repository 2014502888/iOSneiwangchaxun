...
struct MailResult: Identifiable, Equatable {
    ...
    var lastNode: TraceNode? { traces.last }
    ...
    var isAbnormal: Bool {
        ...
        guard let t = TrackParsing.parseDate(last.time) else { return false }
...
// MARK: - 结果标签页
enum ResultTab: String, CaseIterable, Hashable, Identifiable {
    case success
    case abnormal
    case failed
    case duplicate
